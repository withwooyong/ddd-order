package com.example.dddorder.common.interceptor;
...
public class CommonHttpRequestInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) {
        ...
        log.debug("requestEventId={}", requestEventId);
        log.info("requestEventId={}", requestEventId);
        log.error("requestEventId={}", requestEventId);
